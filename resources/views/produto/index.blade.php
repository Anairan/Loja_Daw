...
@section("formulario")
	...
	<form action="/produto" method="POST" class="row" onsubmit="carregaDados();">
		<div class="form-group col-5">
			...
			"form-control" value="{{ $produto->descricao }}" />
		...
		<div class="form-group col-5">
			...
			<input type="text" id="preco_mask" class="form-control" 
			value="{{$produto->id== ''?'': number_format( $produto->preco , 2)}}" />
			</div>
...
@section("tabela")
	<div class="row" style="margin-top: 50px;">
		...
		<input type="text" id="q" placeholder="Pesquisar por descricao..."
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="/produto/{{$produto->id }}/edit"
			...
			<td>
				<form action="/produto/{{$produto->id}}"
				method="POST">
					@csrf
